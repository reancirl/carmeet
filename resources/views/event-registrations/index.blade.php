                    ...
                    @if (!$registrations->isEmpty())
                        ...
                        <div class="grid grid-cols-1 gap-6">
                            @foreach ($registrations as $registration)
                                <div
                                    class="bg-white dark:bg-gray-700 overflow-hidden shadow-sm sm:rounded-lg border border-gray-200 dark:border-gray-600">
                                    <div class="p-5">
                                        <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                                            <!-- Event Info -->
                                            <div class="col-span-2">
                                                <h2 class="text-xl font-bold text-gray-800 dark:text-gray-200 mb-2">
                                                    {{ $registration->event->name ?? 'N/A' }}</h2>

                                                @if ($registration->event->is_multi_day)
                                                    <div
                                                        class="flex items-center text-gray-600 dark:text-gray-400 text-sm mb-1">
                                                    ...
                                                    @foreach ($registration->event->days->take(2) as $day)
                                                        <div
                                                            class="flex items-center text-gray-600 dark:text-gray-400 text-sm mb-1 ml-5">
                                                            <div class="flex-shrink-0 w-4 mr-1"></div>
                                                            <!-- Spacing to align with icon above -->
                                                            {{ \Carbon\Carbon::parse($day->date)->format('F d, Y') }}:
                                                            {{ date('g:i A', strtotime($day->start_time)) }} -
                                                            {{ date('g:i A', strtotime($day->end_time)) }}
                                                        </div>
                                                    @endforeach

                                                    @if ($registration->event->days->count() > 2)
                                                        <div
                                                            class="flex items-center text-gray-600 dark:text-gray-400 text-sm mb-1 ml-5 italic">
                                                            <div class="flex-shrink-0 w-4 mr-1"></div>
                                                            <!-- Spacing to align with icon above -->
                                                ...
                                                <div class="mt-3 text-sm text-gray-500 dark:text-gray-400">
                                                    <p><span class="font-medium">Registered Car:</span>
                                                        @if ($registration->carProfile)
                                                            {{ $registration->carProfile->year }}
                                                            {{ $registration->carProfile->make }}
                                                            {{ $registration->carProfile->model }}
                                                        @else
                                                            N/A
                                                        @endif
                                                    </p>
                                                    ...
                                                    @if ($registration->crew_name)
                                                        <p class="mt-1"><span class="font-medium">Crew:</span>
                                                            {{ $registration->crew_name }}</p>
                                                    @endif

                                                    @if ($registration->class)
                                                        <p class="mt-1"><span class="font-medium">Class:</span>
                                            ...
                                            <!-- Status Info -->
                                            <div
                                                class="md:border-l md:border-r border-gray-200 dark:border-gray-600 md:px-6 flex flex-col justify-center">
                                                <div class="text-center">
                                                    ...
                                                    @switch($registration->status)
                                                        @case('pending')
                                                            <div
                                                                class="inline-flex items-center px-4 py-2 rounded-full font-medium bg-yellow-100 text-yellow-800 dark:bg-yellow-800/30 dark:text-yellow-500">
                                                        ...
                                                        @case('approved')
                                                            <div
                                                                class="inline-flex items-center px-4 py-2 rounded-full font-medium bg-green-100 text-green-800 dark:bg-green-800/30 dark:text-green-500">
                                                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-1.5"
                                                                    fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                                    <path stroke-linecap="round" stroke-linejoin="round"
                                                                        stroke-width="2"
                                                        ...
                                                        @case('waitlisted')
                                                            <div
                                                                class="inline-flex items-center px-4 py-2 rounded-full font-medium bg-blue-100 text-blue-800 dark:bg-blue-800/30 dark:text-blue-500">
                                                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-1.5"
                                                                    fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                                    <path stroke-linecap="round" stroke-linejoin="round"
                                                                        stroke-width="2"
                                                        ...
                                                        @case('denied')
                                                            <div
                                                                class="inline-flex items-center px-4 py-2 rounded-full font-medium bg-red-100 text-red-800 dark:bg-red-800/30 dark:text-red-500">
                                                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-1.5"
                                                                    fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                                    <path stroke-linecap="round" stroke-linejoin="round"
                                                                        stroke-width="2"
                                                        ...
                                                        @default
                                                            <div
                                                                class="inline-flex items-center px-4 py-2 rounded-full font-medium bg-gray-100 text-gray-800 dark:bg-gray-800/30 dark:text-gray-500">
                                                    ...
                                                    <div class="mt-4">
                                                        ...
                                                        @if ($registration->is_paid)
                                                            <div
                                                                class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-green-100 text-green-800 dark:bg-green-800/30 dark:text-green-500">
                                                        ...
                                                        @else
                                                            <div
                                                                class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-gray-100 text-gray-800 dark:bg-gray-800/30 dark:text-gray-500">
                                                                <svg xmlns="http://www.w3.org/2000/svg"
                                                                    class="h-4 w-4 mr-1" fill="none"
                                                                    viewBox="0 0 24 24" stroke="currentColor">
                                                                    <path stroke-linecap="round"
                                            ...
                                            <div class="flex flex-col items-center justify-center space-y-3">
                                                <a href="{{ route('event-registrations.show', $registration) }}"
                                                ...
                                                Entry Pass
                                                    ...
                                                    <!-- View QR Code -->
                                                    <a href="{{ route('event-registrations.confirmation', $registration) }}"
                                            ...
                                            <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                                                ...
                                                <div class="col-span-2">
                                                    <h2
                                                        ...
                                                        {{ $attendedEventId->event->name ?? 'N/A' }}</h2>
                                                    ...
                                                    @if ($attendedEventId->event->is_multi_day)
                                                        ...
                                                        @if ($attendedEventId->event->days->count() > 2)
                                                            <div
                                                                ...
                                                                <div class="flex-shrink-0 w-4 mr-1"></div>
                                                                <!-- Spacing to align with icon above -->
                                                                + {{ $attendedEventId->event->days->count() - 2 }} more
                                                                days...
                                                            </div>
                                                        @endif
                                                    @else
                    ...
                    @else
                        ...
                        @else
                            <div class="text-center py-8">
                                <p class="text-gray-500 dark:text-gray-400 mb-4">You haven't registered for any events
                                    yet.</p>
